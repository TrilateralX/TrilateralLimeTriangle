...
class HXCPP_CLASS_ATTRIBUTES Sketch_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::trilateral3::drawing::Sketch create( ::Dynamic drawType_, ::Dynamic colorType_,int sketchForm_,::hx::Null< int >  endLine_);
		...
		::Array< ::Dynamic> pointsNoEndOverlap();
		::Dynamic pointsNoEndOverlap_dyn();

		::Array< ::Dynamic> pointsRewound();
		::Dynamic pointsRewound_dyn();

		 ::Dynamic initDim();
		::Dynamic initDim_dyn();

		void updateDim(Float x,Float y);
		...
		void lastClock();
		::Dynamic lastClock_dyn();

		::Array< ::Dynamic> getEdges();
		...
		void quadThru(Float x1,Float y1,Float x2,Float y2);
		::Dynamic quadThru_dyn();

		void curveTo(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3);
		::Dynamic curveTo_dyn();

		void plotCoord(::Array< Float > arr, ::Dynamic withMove);
		::Dynamic plotCoord_dyn();

		void aiString(::String str,Float x,Float y,::hx::Null< Float >  flipY);
		::Dynamic aiString_dyn();
