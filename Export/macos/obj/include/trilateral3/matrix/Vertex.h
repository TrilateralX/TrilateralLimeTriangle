...
HX_DECLARE_STACK_FRAME(_hx_pos_ecc600380690180e_11_new)
			...
			*(void **)__this = Vertex_obj::_hx_vtable;
{
            	...
            	HX_STACKFRAME(&_hx_pos_ecc600380690180e_11_new)
HXLINE(  15)		( ( ::trilateral3::matrix::Vertex)(__this) )->w = ((Float)1.);
HXLINE(  14)		( ( ::trilateral3::matrix::Vertex)(__this) )->z = ((Float)0.);
HXLINE(  13)		( ( ::trilateral3::matrix::Vertex)(__this) )->y = ((Float)0.);
HXLINE(  12)		( ( ::trilateral3::matrix::Vertex)(__this) )->x = ((Float)0.);
HXLINE(  17)		( ( ::trilateral3::matrix::Vertex)(__this) )->x = x;
HXLINE(  18)		( ( ::trilateral3::matrix::Vertex)(__this) )->y = y;
HXLINE(  19)		( ( ::trilateral3::matrix::Vertex)(__this) )->z = z;
HXLINE(  20)		( ( ::trilateral3::matrix::Vertex)(__this) )->w = w;
            	}
