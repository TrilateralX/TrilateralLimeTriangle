...
HXLINE(  56)		 ::Dynamic bundle;
HXDLIN(  56)		::String data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXDLIN(  56)		 ::lime::utils::AssetManifest manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXDLIN(  56)		 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  72)		::lime::utils::Assets_obj::registerLibrary(HX_("default",c1,d8,c3,9b),library);
HXLINE(  75)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  76)		if (::hx::IsNotNull( library )) {
HXLINE(  76)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  77)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
