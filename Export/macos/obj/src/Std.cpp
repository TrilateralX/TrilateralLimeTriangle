...
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_25_is,"Std","is",0x3c56d6f5,"Std.is","/usr/local/lib/haxe/std/cpp/_std/Std.hx",25,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_29_isOfType,"Std","isOfType",0x6718c846,"Std.isOfType","/usr/local/lib/haxe/std/cpp/_std/Std.hx",29,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_33_downcast,"Std","downcast",0x4619c56c,"Std.downcast","/usr/local/lib/haxe/std/cpp/_std/Std.hx",33,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_38_instance,"Std","instance",0x1431f4e0,"Std.instance","/usr/local/lib/haxe/std/cpp/_std/Std.hx",38,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_42_string,"Std","string",0xcf48855c,"Std.string","/usr/local/lib/haxe/std/cpp/_std/Std.hx",42,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_46_int,"Std","int",0x8fa53b84,"Std.int","/usr/local/lib/haxe/std/cpp/_std/Std.hx",46,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_50_parseInt,"Std","parseInt",0x90c2ebc7,"Std.parseInt","/usr/local/lib/haxe/std/cpp/_std/Std.hx",50,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_54_parseFloat,"Std","parseFloat",0xbca10a74,"Std.parseFloat","/usr/local/lib/haxe/std/cpp/_std/Std.hx",54,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_57_random,"Std","random",0x75a77e8e,"Std.random","/usr/local/lib/haxe/std/cpp/_std/Std.hx",57,0xe751091d)
...
bool Std_obj::is( ::Dynamic v, ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_25_is)
...
bool Std_obj::isOfType( ::Dynamic v, ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_29_isOfType)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,isOfType,return )
 ...
 ::Dynamic Std_obj::downcast( ::Dynamic value,::hx::Class c){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_33_downcast)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,downcast,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,::hx::Class c){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_38_instance)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_42_string)
...
int Std_obj::_hx_int(Float x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_46_int)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_50_parseInt)
...
Float Std_obj::parseFloat(::String x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_54_parseFloat)
...
int Std_obj::random(int x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_57_random)
HXLINE(  58)		if ((x <= 0)) {
HXLINE(  59)			return 0;
            		}
