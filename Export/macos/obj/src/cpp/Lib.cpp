...
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_38_load,"cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","/usr/local/lib/haxe/std/cpp/Lib.hx",38,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_66_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",66,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_70_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",70,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_71_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",71,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_72_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",72,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_73_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",73,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_74_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",74,0x8e9e6562)
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_75_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/local/lib/haxe/std/cpp/Lib.hx",75,0x8e9e6562)
namespace cpp{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Lib_obj,load,return )
 ...
 ::Dynamic Lib_obj::loadLazy(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_8919090b4e67b3fc_66_loadLazy)
HXDLIN(  66)		try {
...
HXLINE(  69)				switch((int)(nargs)){
            					case (int)0: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::Dynamic,e) HXARGC(0)
            						 ::Dynamic _hx_run(){
            							HX_STACKFRAME(&_hx_pos_8919090b4e67b3fc_70_loadLazy)
            					...
            					case (int)2: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::Dynamic,e) HXARGC(2)
            						 ::Dynamic _hx_run( ::Dynamic _, ::Dynamic _1){
            							HX_STACKFRAME(&_hx_pos_8919090b4e67b3fc_71_loadLazy)
            					...
            					case (int)3: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_3, ::Dynamic,e) HXARGC(3)
            						 ::Dynamic _hx_run( ::Dynamic _, ::Dynamic _1, ::Dynamic _2){
            							HX_STACKFRAME(&_hx_pos_8919090b4e67b3fc_72_loadLazy)
