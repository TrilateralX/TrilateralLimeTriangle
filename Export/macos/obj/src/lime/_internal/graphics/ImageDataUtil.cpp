...
HXDLIN(1233)			if (::hx::IsPointerEq( endian,::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn() )) {
...
HXLINE(1245)			bool littleEndian = ::hx::IsPointerNotEq( endian,::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn() );
HXLINE(1247)			{
