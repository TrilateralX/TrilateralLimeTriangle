...
HXLINE( 299)			::Sys_obj::command(HX_("/usr/bin/open",5c,58,a2,62),::Array_obj< ::String >::__new(1)->init(0,path));
            		}
            	}
...
HXLINE( 621)			::lime::_hx_system::System_obj::_hx___deviceModel = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sysctl",ae,bd,d5,f2),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_23,2));
            		}
...
HXLINE( 647)			::lime::_hx_system::System_obj::_hx___deviceVendor = HX_("Apple",3a,f5,68,b7);
            		}
...
HXLINE( 730)			::String name = ::lime::_hx_system::System_obj::get_platformName();
HXLINE( 731)			::String version = ::lime::_hx_system::System_obj::get_platformVersion();
HXLINE( 732)			bool _hx_tmp;
HXDLIN( 732)			if (::hx::IsNotNull( name )) {
HXLINE( 732)				_hx_tmp = ::hx::IsNotNull( version );
            			}
            			else {
HXLINE( 732)				_hx_tmp = false;
            			}
HXDLIN( 732)			if (_hx_tmp) {
HXLINE( 732)				::lime::_hx_system::System_obj::_hx___platformLabel = ((name + HX_(" ",20,00,00,00)) + version);
            			}
            			else {
HXLINE( 733)				if (::hx::IsNotNull( name )) {
HXLINE( 733)					::lime::_hx_system::System_obj::_hx___platformLabel = name;
            				}
            			}
            		}
...
HXLINE( 747)			::lime::_hx_system::System_obj::_hx___platformName = HX_("macOS",73,51,16,03);
            		}
...
HXLINE( 795)			::lime::_hx_system::System_obj::_hx___platformVersion = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sw_vers",6b,99,f9,43),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_33,1));
            		}
