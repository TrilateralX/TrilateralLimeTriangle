...
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_99_new,"haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",99,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_2249f02c049a2193_144_readDigits,"haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","/usr/local/lib/haxe/std/haxe/Unserializer.hx",144,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_2249f02c049a2193_169_readFloat,"haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","/usr/local/lib/haxe/std/haxe/Unserializer.hx",169,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_2249f02c049a2193_184_unserializeObject,"haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","/usr/local/lib/haxe/std/haxe/Unserializer.hx",184,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_2249f02c049a2193_199_unserializeEnum,"haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",199,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_2249f02c049a2193_231_unserialize,"haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","/usr/local/lib/haxe/std/haxe/Unserializer.hx",231,0x60de4a67)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2249f02c049a2193_465_run,"haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","/usr/local/lib/haxe/std/haxe/Unserializer.hx",465,0x60de4a67)
...
void Unserializer_obj::__construct(::String buf){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_99_new)
...
int Unserializer_obj::readDigits(){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_144_readDigits)
HXLINE( 145)		int k = 0;
...
Float Unserializer_obj::readFloat(){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_169_readFloat)
...
void Unserializer_obj::unserializeObject( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_184_unserializeObject)
...
HX_DEFINE_DYNAMIC_FUNC1(Unserializer_obj,unserializeObject,(void))
 ...
 ::Dynamic Unserializer_obj::unserializeEnum(::hx::Class edecl,::String tag){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_199_unserializeEnum)
...
HX_DEFINE_DYNAMIC_FUNC2(Unserializer_obj,unserializeEnum,return )
 ...
 ::Dynamic Unserializer_obj::unserialize(){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_231_unserialize)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Unserializer_obj,initCodes,return )
 ...
 ::Dynamic Unserializer_obj::run(::String v){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_465_run)
