...
HX_LOCAL_STACK_FRAME(_hx_pos_aef49c9161dcd373_36_unwrap,"haxe.ValueException","unwrap",0xe3875a0b,"haxe.ValueException.unwrap","/usr/local/lib/haxe/std/haxe/ValueException.hx",36,0x518cf4d4)
namespace haxe{
...
bool ValueException_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ValueException_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_aef49c9161dcd373_36_unwrap)
