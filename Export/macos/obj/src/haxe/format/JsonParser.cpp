...
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_312_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",312,0x4a8b222b)
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_318_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",318,0x4a8b222b)
namespace haxe{
namespace format{
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_312_invalidChar)
HXLINE( 313)		this->pos--;
HXLINE( 314)		::String _hx_tmp = ((HX_("Invalid char ",81,66,ec,29) + this->str.cca(this->pos)) + HX_(" at position ",0a,c2,01,e0));
HXDLIN( 314)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((_hx_tmp + this->pos)));
            	}
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_318_invalidNumber)
HXDLIN( 318)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((((HX_("Invalid number at position ",d8,9d,6f,13) + start) + HX_(": ",a6,32,00,00)) + this->str.substr(start,(this->pos - start)))));
            	}
