...
HX_LOCAL_STACK_FRAME(_hx_pos_48ae2dbc707ed6b9_137_ARGB_CYMKA,"trilateral3.color._ColorInt.ColorInt_Impl_","ARGB_CYMKA",0xf79e00c7,"trilateral3.color._ColorInt.ColorInt_Impl_.ARGB_CYMKA","trilateral3/color/ColorInt.hx",137,0xd37a4f9e)
HX_LOCAL_STACK_FRAME(_hx_pos_48ae2dbc707ed6b9_147_CYMKA_ARGB,"trilateral3.color._ColorInt.ColorInt_Impl_","CYMKA_ARGB",0x1ae6bceb,"trilateral3.color._ColorInt.ColorInt_Impl_.CYMKA_ARGB","trilateral3/color/ColorInt.hx",147,0xd37a4f9e)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(ColorInt_Impl__obj,aiCYMKA,return )
 ...
 ::trilateral3::structure::CYMKA ColorInt_Impl__obj::ARGB_CYMKA( ::trilateral3::structure::ARGB v){
            	HX_GC_STACKFRAME(&_hx_pos_48ae2dbc707ed6b9_137_ARGB_CYMKA)
HXLINE( 138)		Float k = (((Float)1.) - ::Math_obj::max(::Math_obj::max(v->r,v->b),v->g));
HXLINE( 139)		Float c = (((((Float)1.) - v->r) - k) / (((Float)1.) - k));
HXLINE( 140)		Float m = (((((Float)1.) - v->g) - k) / (((Float)1.) - k));
HXLINE( 141)		Float y = (((((Float)1.) - v->b) - k) / (((Float)1.) - k));
HXLINE( 142)		return  ::trilateral3::structure::CYMKA_obj::__alloc( HX_CTX ,c,y,m,k,v->a);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ColorInt_Impl__obj,ARGB_CYMKA,return )
 ...
 ::trilateral3::structure::ARGB ColorInt_Impl__obj::CYMKA_ARGB( ::trilateral3::structure::CYMKA v){
            	HX_GC_STACKFRAME(&_hx_pos_48ae2dbc707ed6b9_147_CYMKA_ARGB)
HXLINE( 148)		Float r = ((( (Float)(1) ) - (v->c / ( (Float)(100) ))) * (( (Float)(1) ) - (v->k / ( (Float)(100) ))));
HXLINE( 149)		Float g = ((( (Float)(1) ) - (v->m / ( (Float)(100) ))) * (( (Float)(1) ) - (v->k / ( (Float)(100) ))));
HXLINE( 150)		Float b = ((( (Float)(1) ) - (v->y / ( (Float)(100) ))) * (( (Float)(1) ) - (v->k / ( (Float)(100) ))));
HXLINE( 151)		return  ::trilateral3::structure::ARGB_obj::__alloc( HX_CTX ,v->a,r,g,b);
            	}
