...
HX_DEFINE_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_13_new,"trilateral3.drawing.Pen","new",0x0b5158b4,"trilateral3.drawing.Pen.new","trilateral3/drawing/Pen.hx",13,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_32_transformRange,"trilateral3.drawing.Pen","transformRange",0x2bd130dd,"trilateral3.drawing.Pen.transformRange","trilateral3/drawing/Pen.hx",32,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_35_up,"trilateral3.drawing.Pen","up",0x11454487,"trilateral3.drawing.Pen.up","trilateral3/drawing/Pen.hx",35,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_40_down,"trilateral3.drawing.Pen","down",0xd547b98e,"trilateral3.drawing.Pen.down","trilateral3/drawing/Pen.hx",40,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_46_back,"trilateral3.drawing.Pen","back",0xd3ea9b53,"trilateral3.drawing.Pen.back","trilateral3/drawing/Pen.hx",46,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_50_transBack,"trilateral3.drawing.Pen","transBack",0x209b51c3,"trilateral3.drawing.Pen.transBack","trilateral3/drawing/Pen.hx",50,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_79_cornerColor,"trilateral3.drawing.Pen","cornerColor",0xdaa819a2,"trilateral3.drawing.Pen.cornerColor","trilateral3/drawing/Pen.hx",79,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_85_cornerColors,"trilateral3.drawing.Pen","cornerColors",0x786e5491,"trilateral3.drawing.Pen.cornerColors","trilateral3/drawing/Pen.hx",85,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_89_middleColor,"trilateral3.drawing.Pen","middleColor",0x8cdfd622,"trilateral3.drawing.Pen.middleColor","trilateral3/drawing/Pen.hx",89,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_93_middleColors,"trilateral3.drawing.Pen","middleColors",0xb6fb8811,"trilateral3.drawing.Pen.middleColors","trilateral3/drawing/Pen.hx",93,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_98_colorTriangles,"trilateral3.drawing.Pen","colorTriangles",0xb81d4af4,"trilateral3.drawing.Pen.colorTriangles","trilateral3/drawing/Pen.hx",98,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_105_addTriangle,"trilateral3.drawing.Pen","addTriangle",0x061df25d,"trilateral3.drawing.Pen.addTriangle","trilateral3/drawing/Pen.hx",105,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_115_triangle2DFill,"trilateral3.drawing.Pen","triangle2DFill",0x3f48ec69,"trilateral3.drawing.Pen.triangle2DFill","trilateral3/drawing/Pen.hx",115,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_125_get_pos,"trilateral3.drawing.Pen","get_pos",0xd0d4687f,"trilateral3.drawing.Pen.get_pos","trilateral3/drawing/Pen.hx",125,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_128_set_pos,"trilateral3.drawing.Pen","set_pos",0xc3d5f98b,"trilateral3.drawing.Pen.set_pos","trilateral3/drawing/Pen.hx",128,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_139_get_triangleCurrent,"trilateral3.drawing.Pen","get_triangleCurrent",0x3dc52dbc,"trilateral3.drawing.Pen.get_triangleCurrent","trilateral3/drawing/Pen.hx",139,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_147_get_color3Current,"trilateral3.drawing.Pen","get_color3Current",0x28ee8b54,"trilateral3.drawing.Pen.get_color3Current","trilateral3/drawing/Pen.hx",147,0xcfd64fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_150_copyRange,"trilateral3.drawing.Pen","copyRange",0x5cf9491c,"trilateral3.drawing.Pen.copyRange","trilateral3/drawing/Pen.hx",150,0xcfd64fbe)
namespace trilateral3{
namespace drawing{

void Pen_obj::__construct( ::Dynamic drawType_, ::Dynamic colorType_){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_13_new)
HXLINE(  25)		this->indices = ::Array_obj< int >::__new(0);
HXLINE(  16)		this->currentColor = 16435934;
HXLINE(  15)		this->dz = ((Float)0.01);
HXLINE(  14)		this->rounded = ((Float)30);
HXLINE(  27)		this->drawType = drawType_;
HXLINE(  28)		this->colorType = colorType_;
            	}
...
void Pen_obj::transformRange( ::trilateral3::matrix::MatrixDozen trans, ::trilateral3::structure::StartEnd ir){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_32_transformRange)
HXDLIN(  32)		this->drawType->__Field(HX_("transformRange",b1,c0,a1,5a),::hx::paccDynamic)(trans,ir);
            	}
...
void Pen_obj::up( ::trilateral3::structure::StartEnd ir){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_35_up)
HXLINE(  36)		 ::trilateral3::matrix::MatrixDozen trans = ( ( ::trilateral3::matrix::MatrixDozen)(this->translateZ((this->dz / ( (Float)(2) )))) );
HXLINE(  37)		this->drawType->__Field(HX_("transformRange",b1,c0,a1,5a),::hx::paccDynamic)(trans,ir);
            	}
...
void Pen_obj::down( ::trilateral3::structure::StartEnd ir){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_40_down)
HXLINE(  41)		 ::trilateral3::matrix::MatrixDozen trans = ( ( ::trilateral3::matrix::MatrixDozen)(this->translateZ((-(this->dz) / ( (Float)(2) )))) );
HXLINE(  42)		this->drawType->__Field(HX_("transformRange",b1,c0,a1,5a),::hx::paccDynamic)(trans,ir);
            	}
...
void Pen_obj::back( ::trilateral3::structure::StartEnd ir){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_46_back)
HXDLIN(  46)		 ::trilateral3::matrix::MatrixDozen r = ( ( ::trilateral3::matrix::MatrixDozen)(this->rotateX(::Math_obj::PI)) );
HXDLIN(  46)		 ::trilateral3::matrix::MatrixDozen s = ( ( ::trilateral3::matrix::MatrixDozen)(this->translateX(this->dz)) );
HXDLIN(  46)		 ::trilateral3::matrix::MatrixDozen m = ( ( ::trilateral3::matrix::MatrixDozen)( ::Dynamic(::hx::Anon_obj::Create(12)
            			->setFixed(0,HX_("a",61,00,00,00),(((r->a * s->a) + (r->b * s->e)) + (r->c * s->i)))
            			->setFixed(1,HX_("b",62,00,00,00),(((r->a * s->b) + (r->b * s->f)) + (r->c * s->j)))
            			->setFixed(2,HX_("c",63,00,00,00),(((r->a * s->c) + (r->b * s->g)) + (r->c * s->k)))
            			->setFixed(3,HX_("d",64,00,00,00),((((r->a * s->d) + (r->b * s->h)) + (r->c * s->l)) + r->d))
            			->setFixed(4,HX_("e",65,00,00,00),(((r->e * s->a) + (r->f * s->e)) + (r->g * s->i)))
            			->setFixed(5,HX_("f",66,00,00,00),(((r->e * s->b) + (r->f * s->f)) + (r->g * s->j)))
            			->setFixed(6,HX_("g",67,00,00,00),(((r->e * s->c) + (r->f * s->g)) + (r->g * s->k)))
            			->setFixed(7,HX_("h",68,00,00,00),((((r->e * s->d) + (r->f * s->h)) + (r->g * s->l)) + r->h))
            			->setFixed(8,HX_("i",69,00,00,00),(((r->i * s->a) + (r->j * s->e)) + (r->k * s->i)))
            			->setFixed(9,HX_("j",6a,00,00,00),(((r->i * s->b) + (r->j * s->f)) + (r->k * s->j)))
            			->setFixed(10,HX_("k",6b,00,00,00),(((r->i * s->c) + (r->j * s->g)) + (r->k * s->k)))
            			->setFixed(11,HX_("l",6c,00,00,00),((((r->i * s->d) + (r->j * s->h)) + (r->k * s->l)) + r->l)))) );
HXDLIN(  46)		this->drawType->__Field(HX_("transformRange",b1,c0,a1,5a),::hx::paccDynamic)(m,ir);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Pen_obj,back,(void))
 ...
 ::trilateral3::matrix::MatrixDozen Pen_obj::transBack(){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_50_transBack)
HXDLIN(  50)		 ::trilateral3::matrix::MatrixDozen r = ( ( ::trilateral3::matrix::MatrixDozen)(this->rotateX(::Math_obj::PI)) );
HXDLIN(  50)		 ::trilateral3::matrix::MatrixDozen s = ( ( ::trilateral3::matrix::MatrixDozen)(this->translateX(this->dz)) );
HXDLIN(  50)		 ::trilateral3::matrix::MatrixDozen m = ( ( ::trilateral3::matrix::MatrixDozen)( ::Dynamic(::hx::Anon_obj::Create(12)
            			->setFixed(0,HX_("a",61,00,00,00),(((r->a * s->a) + (r->b * s->e)) + (r->c * s->i)))
            			->setFixed(1,HX_("b",62,00,00,00),(((r->a * s->b) + (r->b * s->f)) + (r->c * s->j)))
            			->setFixed(2,HX_("c",63,00,00,00),(((r->a * s->c) + (r->b * s->g)) + (r->c * s->k)))
            			->setFixed(3,HX_("d",64,00,00,00),((((r->a * s->d) + (r->b * s->h)) + (r->c * s->l)) + r->d))
...
void Pen_obj::cornerColor(::hx::Null< int >  __o_color){
            	...
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_79_cornerColor)
HXLINE(  80)		if ((color == -1)) {
HXLINE(  80)			color = this->currentColor;
            		}
HXLINE(  81)		this->colorType->__Field(HX_("cornerColors",65,87,ed,a2),::hx::paccDynamic)(color,color,color);
            	}
...
void Pen_obj::cornerColors(int colorA,int colorB,int colorC){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_85_cornerColors)
HXDLIN(  85)		this->colorType->__Field(HX_("cornerColors",65,87,ed,a2),::hx::paccDynamic)(colorA,colorB,colorC);
            	}
...
void Pen_obj::middleColor(int color,int colorCentre){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_89_middleColor)
HXDLIN(  89)		this->colorType->__Field(HX_("cornerColors",65,87,ed,a2),::hx::paccDynamic)(colorCentre,color,color);
            	}
...
void Pen_obj::middleColors(int color,int colorCentre,int times){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_93_middleColors)
HXDLIN(  93)		int _g = 0;
HXDLIN(  93)		int _g1 = times;
HXDLIN(  93)		while((_g < _g1)){
HXDLIN(  93)			_g = (_g + 1);
HXDLIN(  93)			int i = (_g - 1);
HXLINE(  94)			this->colorType->__Field(HX_("cornerColors",65,87,ed,a2),::hx::paccDynamic)(colorCentre,color,color);
            		}
            	}
...
void Pen_obj::colorTriangles(int color,int times){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_98_colorTriangles)
HXLINE(  99)		if ((color == -1)) {
HXLINE(  99)			color = this->currentColor;
            		}
HXLINE( 100)		this->colorType->__Field(HX_("colorTriangles",c8,da,ed,e6),::hx::paccDynamic)(color,times);
            	}
...
void Pen_obj::addTriangle(Float ax,Float ay,Float az,Float bx,Float by,Float bz,Float cx,Float cy,Float cz){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_105_addTriangle)
HXLINE( 107)		this->drawType->__Field(HX_("triangle",c8,be,c5,8d),::hx::paccDynamic)(ax,ay,az,bx,by,bz,cx,cy,cz);
HXLINE( 108)		if (::hx::IsNotNull( ::trilateral3::Trilateral_obj::transformMatrix )) {
HXLINE( 108)			this->drawType->__Field(HX_("transform",6c,2d,93,45),::hx::paccDynamic)(::trilateral3::Trilateral_obj::transformMatrix);
            		}
HXLINE( 109)		this->drawType->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
            	}
...
int Pen_obj::triangle2DFill(Float ax,Float ay,Float bx,Float by,Float cx,Float cy,::hx::Null< int >  __o_color){
            		int color = __o_color.Default(-1);
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_115_triangle2DFill)
HXLINE( 117)		if ((color == -1)) {
HXLINE( 117)			color = this->currentColor;
            		}
HXLINE( 118)		{
HXLINE( 118)			this->drawType->__Field(HX_("triangle",c8,be,c5,8d),::hx::paccDynamic)(ax,ay,0,bx,by,0,cx,cy,0);
HXDLIN( 118)			if (::hx::IsNotNull( ::trilateral3::Trilateral_obj::transformMatrix )) {
HXLINE( 118)				this->drawType->__Field(HX_("transform",6c,2d,93,45),::hx::paccDynamic)(::trilateral3::Trilateral_obj::transformMatrix);
            			}
HXDLIN( 118)			this->drawType->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
            		}
HXLINE( 119)		this->colorType->__Field(HX_("cornerColors",65,87,ed,a2),::hx::paccDynamic)(color,color,color);
HXLINE( 120)		return 1;
            	}
...
Float Pen_obj::get_pos(){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_125_get_pos)
HXDLIN( 125)		return ( (Float)(this->drawType->__Field(HX_("get_pos",2b,26,ca,26),::hx::paccDynamic)()) );
            	}
...
Float Pen_obj::set_pos(Float v){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_128_set_pos)
HXLINE( 129)		this->drawType->__Field(HX_("set_pos",37,b7,cb,19),::hx::paccDynamic)(v);
HXLINE( 130)		this->colorType->__Field(HX_("set_pos",37,b7,cb,19),::hx::paccDynamic)(v);
HXLINE( 131)		return v;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Pen_obj,set_pos,return )
 ...
 ::Dynamic Pen_obj::get_triangleCurrent(){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_139_get_triangleCurrent)
HXDLIN( 139)		return this->drawType->__Field(HX_("triangleCurrent",51,ee,2b,9e),::hx::paccDynamic);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Pen_obj,get_triangleCurrent,return )
 ...
 ::Dynamic Pen_obj::get_color3Current(){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_147_get_color3Current)
HXDLIN( 147)		return this->colorType->__Field(HX_("color3current",c9,64,01,5a),::hx::paccDynamic);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Pen_obj,get_color3Current,return )
 ...
 ::trilateral3::structure::StartEnd Pen_obj::copyRange( ::trilateral3::drawing::Pen otherPen, ::trilateral3::structure::StartEnd startEnd, ::trilateral3::matrix::Vertex vec){
            	HX_GC_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_150_copyRange)
HXLINE( 151)		Float start = ( (Float)(this->drawType->__Field(HX_("get_pos",2b,26,ca,26),::hx::paccDynamic)()) );
HXLINE( 152)		{
HXLINE( 152)			Float v = ( (Float)(startEnd->start) );
HXDLIN( 152)			otherPen->drawType->__Field(HX_("set_pos",37,b7,cb,19),::hx::paccDynamic)(v);
HXDLIN( 152)			otherPen->colorType->__Field(HX_("set_pos",37,b7,cb,19),::hx::paccDynamic)(v);
            		}
HXLINE( 153)		 ::trilateral3::structure::TriInt colors;
HXLINE( 154)		{
HXLINE( 154)			int _g = startEnd->start;
HXDLIN( 154)			int _g1 = (startEnd->end + 1);
HXDLIN( 154)			while((_g < _g1)){
HXLINE( 154)				_g = (_g + 1);
HXDLIN( 154)				int i = (_g - 1);
HXLINE( 155)				 ::trilateral3::structure::Triangle3D tri = ( ( ::trilateral3::structure::Triangle3D)(otherPen->drawType->__Field(HX_("getTriangle3D",af,89,3b,36),::hx::paccDynamic)()) );
HXLINE( 156)				this->drawType->__Field(HX_("triangle",c8,be,c5,8d),::hx::paccDynamic)((tri->a->x + vec->x),(tri->a->y + vec->y),(tri->a->z + vec->z),(tri->b->x + vec->x),(tri->b->y + vec->y),(tri->b->z + vec->z),(tri->c->x + vec->x),(tri->c->y + vec->y),(tri->c->z + vec->z));
HXLINE( 159)				this->drawType->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
            			}
            		}
HXLINE( 163)		int end = ::Std_obj::_hx_int((( (Float)(this->drawType->__Field(HX_("get_pos",2b,26,ca,26),::hx::paccDynamic)()) ) - ( (Float)(1) )));
HXLINE( 164)		 ::trilateral3::structure::StartEnd s0 =  ::trilateral3::structure::StartEnd_obj::__alloc( HX_CTX ,::Std_obj::_hx_int(start),end);
HXLINE( 165)		return s0;
            	}
