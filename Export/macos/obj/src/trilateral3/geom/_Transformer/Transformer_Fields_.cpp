...
bool Transformer_Fields__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::trilateral3::matrix::MatrixDozen Transformer_Fields__obj::multiplyTransform( ::trilateral3::matrix::MatrixDozen r, ::trilateral3::matrix::MatrixDozen s){
            	HX_STACKFRAME(&_hx_pos_24bb7bd5a6e03e96_5_multiplyTransform)
HXLINE(   6)		 ::trilateral3::matrix::MatrixDozen m = ( ( ::trilateral3::matrix::MatrixDozen)( ::Dynamic(::hx::Anon_obj::Create(12)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Transformer_Fields__obj,multiplyTransform,return )
 ...
 ::trilateral3::matrix::Vertex Transformer_Fields__obj::transformVertex( ::trilateral3::matrix::Vertex v, ::trilateral3::matrix::MatrixDozen t){
            	HX_STACKFRAME(&_hx_pos_24bb7bd5a6e03e96_16_transformVertex)
HXLINE(  17)		 ::trilateral3::matrix::Vertex v2 = ( ( ::trilateral3::matrix::Vertex)( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("w",77,00,00,00),((Float)1.))
            			->setFixed(1,HX_("x",78,00,00,00),((((t->a * v->x) + (t->b * v->y)) + (t->c * v->z)) + t->d))
            			->setFixed(2,HX_("y",79,00,00,00),((((t->e * v->x) + (t->f * v->y)) + (t->g * v->z)) + t->h))
            			->setFixed(3,HX_("z",7a,00,00,00),((((t->i * v->x) + (t->j * v->y)) + (t->k * v->z)) + t->l)))) );
HXLINE(  21)		return v2;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Transformer_Fields__obj,transformVertex,return )
 ...
 ::trilateral3::matrix::MatrixDozen Transformer_Fields__obj::unitTransform(){
            	HX_STACKFRAME(&_hx_pos_24bb7bd5a6e03e96_24_unitTransform)
HXLINE(  25)		 ::trilateral3::matrix::MatrixDozen m = ( ( ::trilateral3::matrix::MatrixDozen)( ::Dynamic(::hx::Anon_obj::Create(12)
            			->setFixed(0,HX_("a",61,00,00,00),((Float)1.))
            			->setFixed(1,HX_("b",62,00,00,00),((Float)0.))
            			->setFixed(2,HX_("c",63,00,00,00),((Float)0.))
            			->setFixed(3,HX_("d",64,00,00,00),((Float)0.))
            			->setFixed(4,HX_("e",65,00,00,00),((Float)0.))
            			->setFixed(5,HX_("f",66,00,00,00),((Float)1.))
            			->setFixed(6,HX_("g",67,00,00,00),((Float)0.))
            			->setFixed(7,HX_("h",68,00,00,00),((Float)0.))
            			->setFixed(8,HX_("i",69,00,00,00),((Float)0.))
            			->setFixed(9,HX_("j",6a,00,00,00),((Float)0.))
            			->setFixed(10,HX_("k",6b,00,00,00),((Float)1.))
            			->setFixed(11,HX_("l",6c,00,00,00),((Float)0.)))) );
HXLINE(  28)		return m;
            	}
