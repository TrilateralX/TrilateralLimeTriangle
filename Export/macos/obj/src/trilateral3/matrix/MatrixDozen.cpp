...
HX_DEFINE_STACK_FRAME(_hx_pos_e52bee1e8b043d6c_8_new,"trilateral3.matrix.MatrixDozen","new",0x56b34c63,"trilateral3.matrix.MatrixDozen.new","trilateral3/matrix/MatrixDozen.hx",8,0x14397a8d)
...
HXLINE(  11)		this->l = ((Float)0.);
HXDLIN(  11)		this->k = ((Float)0.);
HXDLIN(  11)		this->j = ((Float)0.);
HXDLIN(  11)		this->i = ((Float)0.);
HXLINE(  10)		this->h = ((Float)0.);
HXDLIN(  10)		this->g = ((Float)0.);
HXDLIN(  10)		this->f = ((Float)0.);
HXDLIN(  10)		this->e = ((Float)0.);
HXLINE(   9)		this->d = ((Float)0.);
HXDLIN(   9)		this->c = ((Float)0.);
HXDLIN(   9)		this->b = ((Float)0.);
HXDLIN(   9)		this->a = ((Float)0.);
HXLINE(  15)		this->a = a;
HXDLIN(  15)		this->b = b;
HXDLIN(  15)		this->c = c;
HXDLIN(  15)		this->d = d;
