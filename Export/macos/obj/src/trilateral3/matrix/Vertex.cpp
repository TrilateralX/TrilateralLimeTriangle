...
HX_DEFINE_STACK_FRAME(_hx_pos_ecc600380690180e_11_new,"trilateral3.matrix.Vertex","new",0xdc408f5c,"trilateral3.matrix.Vertex.new","trilateral3/matrix/Vertex.hx",11,0x645fd974)
...
HXLINE(  15)		this->w = ((Float)1.);
HXLINE(  14)		this->z = ((Float)0.);
HXLINE(  13)		this->y = ((Float)0.);
HXLINE(  12)		this->x = ((Float)0.);
HXLINE(  17)		this->x = x;
HXLINE(  18)		this->y = y;
HXLINE(  19)		this->z = z;
HXLINE(  20)		this->w = w;
