...
HX_DEFINE_STACK_FRAME(_hx_pos_00f1b866daa03499_6_new,"trilateral3.structure.CYMKA","new",0x119cd1bd,"trilateral3.structure.CYMKA.new","trilateral3/structure/CYMKA.hx",6,0x2e2bf195)
...
bool CYMKA_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7fb686c5;
}
...
void CYMKA_obj::__register()
{
	...
	__mClass->mName = HX_("trilateral3.structure.CYMKA",4b,2f,90,66);
