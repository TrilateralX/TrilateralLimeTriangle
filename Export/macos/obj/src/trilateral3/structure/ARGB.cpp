...
HX_DEFINE_STACK_FRAME(_hx_pos_87bed562f2274cd6_6_new,"trilateral3.structure.ARGB","new",0x1f946de0,"trilateral3.structure.ARGB.new","trilateral3/structure/ARGB.hx",6,0xfff64e8e)
...
bool ARGB_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x30c97698;
}
...
void ARGB_obj::__register()
{
	...
	__mClass->mName = HX_("trilateral3.structure.ARGB",ee,3d,18,9a);
