...
HX_LOCAL_STACK_FRAME(_hx_pos_39f5eab4124248fe_91_command,"Sys","command",0x363f8cca,"Sys.command","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",91,0xd23c22f3)
...
int Sys_obj::command(::String cmd,::Array< ::String > args){
            	HX_STACKFRAME(&_hx_pos_39f5eab4124248fe_91_command)
