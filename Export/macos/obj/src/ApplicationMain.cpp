...
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TrilateralLimeTriancle",e5,20,8e,f6),::ApplicationMain_obj::create_dyn());
...
HXLINE(  25)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("2",32,00,00,00));
HXLINE(  26)		app->meta->set(HX_("company",3d,15,69,83),HX_("Nanjizal",eb,41,80,78));
HXLINE(  27)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TrilateralLimeTriancle",e5,20,8e,f6));
HXLINE(  28)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TrilateralLimeTriangle",e9,29,91,f6));
HXLINE(  29)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("net.nanjizal.trilateralLimeTriangle",fb,e7,7b,d2));
...
HXLINE(  34)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TrilateralLimeTriangle",e9,29,91,f6))
